...
var currentEmployee = document.getElementById("currentEmployee").innerHTML;
var creditForm = document.getElementById("credit_form");
var driverName = document.getElementById("driverName");
var plateNumber = document.getElementById("plate");
var creditAmount = document.getElementById("creditAmount");
var shift = document.getElementById("shift");
var collectedAmount = document.getElementById("collectedAmount");
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return fetch("http://localhost:49310/v1/credits/new", {
              method: "POST",
              body: JSON.stringify({
